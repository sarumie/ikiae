document.addEventListener('DOMContentLoaded', () => {
            ...
            plus.onclick = () => {
                document.querySelectorAll('.text-box.active').forEach(box => {
                    if (box !== textBox) {
                        ...
                        box.closest('.text-inside').querySelector('.plus').classList.remove('img_active');
                    }
                });
    ...
    function setupSearch() {
        ...
        document.addEventListener('click', (e) => {
            if (!searchBox.contains(e.target) && !searchBtn.contains(e.target) && searchBox.classList.contains('active')) {
                closeSearch();
            }
        });
    ...
    function setupSmoothScroll() {
        document.querySelector('.bg-link a').addEventListener('click', function(e) {
            e.preventDefault();
